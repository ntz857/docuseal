...
const zh = {
  ...
  scan_the_qr_code_with_the_camera_app_to_open_the_form_on_mobile_and_draw_your_signature: '使用相机应用扫描二维码，打开手机上的表单并绘制您的签名',
  date: '日期',
  number: '数字',
  image: '图片',
  take_photo: '拍照',
  ...
  complete_hightlighted_checkboxes_and_click: '完成高亮的复选框，然后点击',
  submit: '提交',
  next: '下一步',
  ...
  form_has_been_completed: '已完成签署！',
  create_a_free_account: '创建免费账号',
  signed_with: '签署',
  please_check_the_box_to_continue: '请勾选复选框以继续',
  open_source_documents_software: '开源文件软件',
  verified_phone_number: '验证电话号码',
  use_international_format: '使用国际格式：+86xxx',
  six_digits_code: '6位代码',
  change_phone_number: '更改电话号码',
  sending: '发送中...',
  resend_code: '重新发送代码',
  verification_code_has_been_resent: '验证代码已通过短信重新发送',
